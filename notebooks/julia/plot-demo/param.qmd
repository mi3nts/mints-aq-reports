...
df.temperature=Vector{Float64}(df.temperature)
...
df.humidity=Vector{Float64}(df.humidity)
...
df.rainPerInterval=Vector{Float64}(df.rainPerInterval)
...
df.pm0_1=Vector{Float64}(df.pm0_1)
...
df.pm0_3=Vector{Float64}(df.pm0_3)
...
df.pm0_5=Vector{Float64}(df.pm0_5)
...
df.pm1_0=Vector{Float64}(df.pm1_0)
...
df.pm2_5=Vector{Float64}(df.pm2_5)
...
df.pm5_0=Vector{Float64}(df.pm5_0)
...
df.pm10_0=Vector{Float64}(df.pm10_0)
